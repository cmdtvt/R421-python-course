...
####################
Following was read from the file: This is test.
Another test.
##################
'''

file = open("Z:/Tavarat/Programming/pythoncrap/pythonCourse/Chapter5/facts.txt", "r")
print("Following was read from the file: "+file.read())
